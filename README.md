...
| `beforeStart`      | (ctx: BeforeStartContext) => Promise<Record<string, string> \| void> | No       | Async hook run before the process spawns ([Pre-start Hook](#pre-start-hook-beforestart))                                                                                                                                    |
