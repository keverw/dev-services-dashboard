...
| `maxLogLines`        | number                             | 200                      | Maximum number of log entries to keep in memory per service. Each output chunk from the process is one entry, and a chunk can contain multiple newlines, so the rendered line count in the UI may exceed this value                                                                                                                                                                                                                                                                                                                              |
